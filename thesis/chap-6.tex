...
% The low-performance gains from transformer models may be partly attributed to the presence of noise in article contents, as they disrupt the context from being effectively used. Frequency-based methods are not affected as much since they only count words and neglect the context.
