...
Given that the majority of research and resources on media bias are typically focused on the US \cite{allsides, adfontes,rodrigo-2024-systematic-review-media-bias}, it is both practical and reasonable for this project to concentrate on US-based articles and domains.
...
This section will introduce general machine learning concepts and techniques, in correlation to media bias classification and article-level media bias classification.
