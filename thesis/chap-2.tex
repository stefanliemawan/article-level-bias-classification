...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=0.95\linewidth]{images/phrasing_bias_example.png}}
    \fbox{\includegraphics[width=0.95\linewidth]{images/spin_bias_example.png}}
    \fbox{\includegraphics[width=0.95\linewidth]{images/statement_bias_example.png}}
